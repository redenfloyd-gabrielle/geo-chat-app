  ...
  <div class="user-form">
    ...
    <form @submit.prevent="handleSubmit">
      <div class="form-group">
        ...
        <input class="input-text-modal" id="fullname" type="text" v-model="user.fullname" placeholder="Enter full name"
          required />
      </div>

      <div class="form-group">
        <label for="fullname">Username</label>
        <input class="input-text-modal" id="fullname" type="text" v-model="user.username" placeholder="Enter full name"
          required />
      </div>
