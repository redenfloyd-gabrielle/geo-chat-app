    ...
    <div class="login-form">
        ...
        <form @submit.prevent="handleLogin">
            <div class="form-group">
                ...
                <input class="input-text-modal" id="email" v-model="username" placeholder="Enter your email"
                    required />
            </div>
...
<script setup lang="ts">
    ...
    const handleLogin = async () => {
        if (username.value && password.value) {
            ...
            const respond = await appStore.loginUser(username.value, password.value)
